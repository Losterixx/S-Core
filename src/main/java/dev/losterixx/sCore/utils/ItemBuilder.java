...
public class ItemBuilder {
    ...
    public ItemBuilder setMetaData(NamespacedKey key, boolean value) {
    ...
    public ItemBuilder setHideTooltip(boolean s) {
    ...
    public ItemBuilder addEnchantment(Enchantment e, Integer i) {
