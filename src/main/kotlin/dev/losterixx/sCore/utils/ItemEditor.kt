...
class ItemEditor(private val itemStack: ItemStack) {
    ...
    fun setDurability(durability: Int) = apply {
        ...
        if (meta is Damageable) {
            ...
            throw IllegalArgumentException("[ItemEditor] ItemMeta is not Damageable")
        }
    }
    ...
    override fun toString(): String {
        return "ItemEditor(itemMeta=$itemMeta, itemStack=$itemStack)"
    }
}